...
Item {
    ...
    property int workspaceButtonWidth: 28
    ...
    Grid {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                color: ColorUtils.transparentize(Appearance.m3colors.m3secondaryContainer, 1.0)
    ...
    Grid {
        ...
        Repeater {
            ...
            Item {
                ...
                width: vertical ? workspaceButtonWidth : workspaceButtonWidth
                height: vertical ? workspaceButtonWidth : Appearance.sizes.barHeight

                property bool isHovered: false

                scale: isHovered ? (Config.options.bar.workspaces.shimmer?.hoverScale ?? 1.25) : 1.0
                transformOrigin: Item.Bottom

                transform: Translate {
                    y: button.isHovered ? -(Config.options.bar.workspaces.shimmer?.hoverLift ?? 4) : 0
                    Behavior on y {
                        NumberAnimation { duration: Config.options.bar.workspaces.shimmer?.hoverDuration ?? 200; easing.type: Easing.OutCubic }
                    }
                }
